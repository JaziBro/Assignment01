...
function make_album(artistname, albumtitle, albumsongs) {
    return { artistname: artistname, albumtitle: albumtitle, albumsongs: albumsongs };
}
console.log("Drake", "Take Care", "17");
function make_album2(artistname, albumtitle, albumsongs) {
    return { artistname: artistname, albumtitle: albumtitle, albumsongs: albumsongs };
}
console.log("Asim Azhar", "Noor", "5");
function make_album3(artistname, albumtitle, albumsongs) {
    return { artistname: artistname, albumtitle: albumtitle, albumsongs: albumsongs };
}
